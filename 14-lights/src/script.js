...
// Lights transform controls
const lights = {light:pointLight}
gui
    .add(lights,'light',{point:pointLight,rect:rectAreaLight,spot:spotLight})
    .onChange((event)=>{
        console.log(event)
        transformControls.attach(event)
    })
