...
const basicShadow = textureLoader.load('/textures/simpleShadow.jpg')
basicShadow.colorSpace = THREE.SRGBColorSpace
...
const plane = new THREE.Mesh(
    ...
    material//new THREE.MeshBasicMaterial({map:shadowTexture})
)
